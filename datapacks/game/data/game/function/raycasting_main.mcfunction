#for those trying to understand how this datapack works, this is the 7th file you should read (the 7.5th file is players_joining_or_quitting_within_a_round)
