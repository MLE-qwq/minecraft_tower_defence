#for those trying to understand how this datapack works, this is the 6th file you should read
#this function is triggered per tick if the scoreboard game.state.waves_have_started game state is set to 1.., with 2 being having to initialize.
